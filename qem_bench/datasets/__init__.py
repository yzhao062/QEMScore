...
from qem_bench.datasets.schema import FEATURE_SPEC_VERSION, FEATURES, build_features
from qem_bench.datasets.splits import SplitSpec, resolve_split_spec

_LAZY_EXPORTS = {
    "PRESETS": ("qem_bench.datasets.generate", "PRESETS"),
    "generate": ("qem_bench.datasets.generate", "generate"),
    "SPLIT_PRESETS": ("qem_bench.datasets.split_generate", "SPLIT_PRESETS"),
    "generate_split": ("qem_bench.datasets.split_generate", "generate_split"),
}
